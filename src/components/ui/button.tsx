  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        medical: "gradient-primary text-primary-foreground shadow-medium hover:shadow-large hover:opacity-95 active:scale-[0.98]",
        "medical-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground",
        "medical-success": "gradient-success text-success-foreground shadow-medium hover:shadow-large active:scale-[0.98]",
      },
      size: {
